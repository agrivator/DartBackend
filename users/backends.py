...
class JWTShopKeeperAuthentication(authentication.BaseAuthentication):
    authentication_header_prefix = 'Token'
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            user = ShopKeeper.objects.get(pk=payload['id'])
...
class JWTRiderAuthentication(authentication.BaseAuthentication):
    authentication_header_prefix = 'Token'
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            user = Rider.objects.get(pk=payload['id'])
